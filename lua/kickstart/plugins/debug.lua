      ...
      dap.configurations[language] = {
        {
          type = 'pwa-node',
          request = 'attach',
          name = '1. Attach to process using Deno (nvim-dap)',
          program = '${file}',
          cwd = '${workspaceFolder}',
        ...
        },
        {
          type = 'pwa-node',
          request = 'launch',
          name = '2. Launch file using Deno (nvim-dap)',
          program = '${file}',
          cwd = '${workspaceFolder}',
          runtimeExecutable = 'deno',
        ...
        },
        {
          type = 'pwa-node',
          request = 'launch',
          name = '3. Launch file using Node.js (nvim-dap)',
          program = '${file}',
          cwd = '${workspaceFolder}',
        },
        {
          type = 'pwa-node',
          request = 'attach',
          name = '4. Attach to process using Node.js (nvim-dap)',
        ...
        -- requires ts-node to be installed globally or locally
        {
          type = 'pwa-node',
          request = 'launch',
          name = '5. Launch file using Node.js with ts-node/register (nvim-dap)',
          program = '${file}',
          cwd = '${workspaceFolder}',
